...
def report(data):
    ...
    for i in range(repetitions):
        ...
        learner = RandomID3('infogain', feature_sample_size=4)
    ...
    print(f"Results:\n{df}")
    print("Exporting report for exercise 2e...")
    df.to_csv('ensemble_learning/reports/h2e2e_report.csv', index=False)
